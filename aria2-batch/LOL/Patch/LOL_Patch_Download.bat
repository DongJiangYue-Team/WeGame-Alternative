@pushd %~dp0 >nul 2>nul
aria2\aria2c.exe --allow-overwrite="true" -d Resources https://cdn.jsdelivr.net/gh/DongJiangYue-Team/WeGame-Alternative@main/aria2-config/LOL/Patch-Latestversion/LOL_Patch
