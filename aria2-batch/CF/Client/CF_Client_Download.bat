@pushd %~dp0 >nul 2>nul
aria2\aria2c.exe --allow-overwrite="true" -d Resources https://cdn.jsdelivr.net/gh/DongJiangYue-Team/CN_LOL_DNF-Client-Patch-Download@main/aria2-config/CF/Client-Latestversion/CF_Client
